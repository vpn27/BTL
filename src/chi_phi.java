...
public class chi_phi extends javax.swing.JFrame {
   ...
   ResultSet rs=null;
    ...
    public ArrayList<Class_chi_phi> expensList()
    {
        ArrayList<Class_chi_phi> expensList = new ArrayList<Class_chi_phi> ();
       ...
       try{
           ...
           Class_chi_phi expens;
           while(rs.next()){
               expens = new Class_chi_phi(rs.getInt("id"),rs.getString("name"),rs.getString("nature"),rs.getFloat("expens"),rs.getString("date"));
    ...
    public void showTable(){
        ArrayList<Class_chi_phi> list = expensList();
       DefaultTableModel model = (DefaultTableModel)tblExpens.getModel();
    ...
    private void initComponents() {
        ...
        tblExpens.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ và tên", "Nature of Expens", "chi phí", "Date", "Title 6", "Title 7"
            }
        ));
