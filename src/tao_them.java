...
public class tao_them extends javax.swing.JFrame {
   ...
   int pos;
    ...
    public ArrayList<Class_login> dataList()
   {
       ArrayList<Class_login> dataList = new ArrayList<Class_login>(); 
       ...
       try{
           ...
           Class_login Data;
           while(rs.next()){
               Data = new Class_login(rs.getInt("id"),rs.getString("username"),rs.getString("password"),rs.getString("status"));
    ...
    public void showTable(){
        ArrayList<Class_login> list = dataList();
       DefaultTableModel model = (DefaultTableModel)checkoutTable.getModel();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 561, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
