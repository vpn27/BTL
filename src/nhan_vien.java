...
public class nhan_vien extends javax.swing.JFrame {
   ...
   int pos;
    ...
    public ArrayList<Class_Employee> dataList()
   {
       ArrayList<Class_Employee> dataList = new ArrayList<Class_Employee>(); 
       ...
       try{
           ...
           Class_Employee Data;
           while(rs.next()){
               Data = new Class_Employee(rs.getInt("id"),rs.getString("name"),rs.getString("father"),rs.getLong("idcard"),rs.getLong("phone"),rs.getString("designation"),rs.getFloat("salary"));
    ...
    public void showTable(){
        ArrayList<Class_Employee> list = dataList();
       DefaultTableModel model = (DefaultTableModel)checkoutTable.getModel();
    ...
    private void initComponents() {
        ...
        checkoutTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ và Tên", "ID Card", "Designation", "Salary", "Title 6"
            }
        ));
