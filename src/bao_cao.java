...
public class bao_cao extends javax.swing.JFrame {
    ...
    public ArrayList<Class_gia_phong> dataList2()
   {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("| Báo Cáo về khách hàng");
        ...
        checkoutTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ và Tên", "tên", "số cmnd", "Địa chỉ", "IN Date", "OUT Date", "Phone", "quốc gia", "City", "Adult", "Children", "Room Type", "Room No"
            }
        ));
        ...
        btnSave.setText("Print báo cáo khách hàng");
        ...
        btnSave1.setText("Print Customer bảng báo cáo ");
